% Generate a 9*10 matrix spr.dat that describes the senior (65+) people
% ratio as a function of interbirth delay (9 rows, from 2 years to 10
% years) and minimum birth age  (10 rows, 21-30 years old).
% Used for drawing Fig. 6a.

% Generate a 1*20 matrix lambda.dat that describes the net growth rate as
% a function of minimum birth age (20 rows, 15-34 years old).
% Used for drawing Fig. 6b.
